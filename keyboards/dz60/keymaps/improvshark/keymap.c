...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		LT(MO(1), KC_F13),KC_A   , KC_S   , KC_D   , KC_F   , KC_G   , KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,          KC_ENT ,
		KC_LSFT , ___X___, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,          TD(0)  ,
		KC_LCTL ,          KC_LGUI, KC_LALT, LT(MO(1), KC_SPC), KC_F14 ,         KC_SPC , KC_RALT, KC_RGUI, ___X___, KC_MENU,         KC_RCTL),
	/*
		Function Layer
	 */
	LAYOUT(
